...
/**
 * @fileOverview This file is a Typescript Definition File.
 * @author Chris Bowdon <https://github.com/cbowdon>
...
declare module TsMonad {
    ...
    class Either<L, R> implements Monad<R>, Functor<R>, Eq<Either<L, R>> {
        /**
         * @name type
         * @description Inform on the Either content.
         * @fieldOf Either#
         * @private
         * @type EitherType
         */
        ...
        /**
         * @name l
         * @description Hold the Left value.
         * @fieldOf Either#
         * @private
         * @type L
         */
        ...
        /**
         * @name r
         * @description Hold the right value.
         * @fieldOf Either#
         * @private
         * @type R
         */
...
declare module TsMonad {
    ...
    /**
     * @name Monad
     * @description Define a contract to add basic monad functions to an
     *     object.
     */
    interface Monad<T> {
...
declare module TsMonad {
    ...
    class Maybe<T> implements Monad<T>, Functor<T>, Eq<Maybe<T>> {
        /**
         * @name type
         * @description Inform on the Maybe content.
         * @fieldOf Maybe#
         * @private
         * @type MaybeType
         */
        ...
        /**
         * @name value
         * @description Hold the value of the Maybe object.
         * @fieldOf Maybe#
         * @private
         * @type T
         */
...
declare module TsMonad {
    ...
    class Writer<S, T> implements Monad<T>, Eq<Writer<S, T>> {
        /**
         * @name story
         * @description Hold the collection of logs.
         * @fieldOf Writer#
         * @private
         * @type S[]
         */
        ...
        /**
         * @name value
         * @description Hold the wrapped value.
         * @fieldOf Writer#
         * @private
         * @type T
         */
